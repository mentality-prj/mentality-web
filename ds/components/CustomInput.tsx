    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <div className="relative">
          ...
          <Input
            className={cn(
              'focus-visible:bg-background-soft h-8 w-full rounded-full bg-background  text-sm text-primary placeholder-textcolor-tertiary caret-primary shadow-none outline-none hover:bg-background-soft focus:placeholder-transparent [&:not(:placeholder-shown)]:caret-textcolor-primary',
              leftIcon && 'pl-8',
              rightIcon && 'pr-8',
              className,
