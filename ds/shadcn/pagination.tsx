...
const PaginationLink = ({ className, isActive, size = 'icon', children, ...props }: PaginationLinkProps) => (
  <Link
    ...
    className={cn(
      ...
      isActive && 'text-reversed bg-primary', //additional styles if the button is active
      className
    )}
    {...props}
  >
...
const PaginationPrevious = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
  <PaginationLink aria-label="Go to previous page" size="icon" className={cn('gap-1 pl-2.5', className)} {...props}>
