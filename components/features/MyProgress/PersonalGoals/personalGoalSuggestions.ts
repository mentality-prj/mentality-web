...
export function getPersonalGoalSuggestions(t: (key: string) => string): Record<GoalType, SuggestionItem[]> {
  return {
    onetime: [
      ...
      { label: t('Suggestions.Onetime.CookNewDish'), iconKey: 'food' },
      { label: t('Suggestions.Onetime.WalkNewRoute'), iconKey: 'walk' },
      { label: t('Suggestions.Onetime.ArtSession'), iconKey: 'art' },
      { label: t('Suggestions.Onetime.JournalEntry'), iconKey: 'journaling' },
    ],
    shortterm: [
      { label: t('Suggestions.Shortterm.SleepBetter'), preset: week7, iconKey: 'sleep' },
      { label: t('Suggestions.Shortterm.NoSugar'), preset: week7, iconKey: 'food' },
      ...
      { label: t('Suggestions.Shortterm.Stretch'), preset: week7, iconKey: 'sport' },
      { label: t('Suggestions.Shortterm.ReadDaily'), preset: week7, iconKey: 'reading' },
      { label: t('Suggestions.Shortterm.NoCoffee'), preset: week7, iconKey: 'food' },
      { label: t('Suggestions.Shortterm.GratitudeDiary'), preset: week7, iconKey: 'journaling' },
    ...
    longterm: [
      ...
      { label: t('Suggestions.Longterm.HealthyEating'), preset: month30, iconKey: 'food' },
      { label: t('Suggestions.Longterm.JournalMonth'), preset: month30, iconKey: 'journaling' },
      { label: t('Suggestions.Longterm.NewSkill'), iconKey: 'learning' },
      { label: t('Suggestions.Longterm.Volunteer'), iconKey: 'social' },
    ],
    repeating: [
      { label: t('Suggestions.Repeating.CoffeeLimit'), iconKey: 'food' },
      { label: t('Suggestions.Repeating.Water'), iconKey: 'health' },
      { label: t('Suggestions.Repeating.Evening'), iconKey: 'walk' },
      { label: t('Suggestions.Repeating.NoSnacks'), iconKey: 'food' },
      { label: t('Suggestions.Repeating.Floss'), iconKey: 'health' },
      { label: t('Suggestions.Repeating.Steps'), iconKey: 'walk' },
      { label: t('Suggestions.Repeating.Vitamins'), iconKey: 'health' },
